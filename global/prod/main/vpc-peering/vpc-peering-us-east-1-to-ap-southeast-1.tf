resource "aws_vpc_peering_connection" "us_east_1_to_ap_southeast_1" {
  ...
  peer_vpc_id = data.terraform_remote_state.ap_southeast_1_main_prod_remote.outputs.vpc_id
...
module "us_east_1_to_ap_southeast_1_routes" {
  ...
  destination_cidr                = data.terraform_remote_state.ap_southeast_1_main_prod_remote.outputs.vpc_cidr
  source_vpc_route_table_ids      = data.terraform_remote_state.us_east_1_main_prod_remote.outputs.vpc_private_route_table_ids
  destination_vpc_route_table_ids = data.terraform_remote_state.ap_southeast_1_main_prod_remote.outputs.vpc_private_route_table_ids
