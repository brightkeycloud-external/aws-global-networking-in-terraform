...
module "ap_southeast_1_to_us_west_2_routes" {
  ...
  vpc_peering_connection_id       = aws_vpc_peering_connection.ap_southeast_1_to_us_west_2.id
  source_cidr                     = data.terraform_remote_state.ap_southeast_1_main_prod_remote.outputs.vpc_cidr
  destination_cidr                = data.terraform_remote_state.us_west_2_main_prod_remote.outputs.vpc_cidr
  source_vpc_route_table_ids      = data.terraform_remote_state.ap_southeast_1_main_prod_remote.outputs.vpc_private_route_table_ids
