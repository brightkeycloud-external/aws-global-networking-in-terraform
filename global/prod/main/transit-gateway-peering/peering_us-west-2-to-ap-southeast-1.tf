module "us_west_2_to_ap_southeast_1" {
  ...
  destination_cidr                = data.terraform_remote_state.ap_southeast_1_prod_main_remote.outputs.vpc_cidr
  ...
  destination_vpc_route_table_ids = data.terraform_remote_state.ap_southeast_1_prod_main_remote.outputs.vpc_private_route_table_ids
